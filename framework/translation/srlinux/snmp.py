...
class SrlinuxSnmpTranslator(BaseTranslator):
    ...
    def _build_data_structure(self, intent: SnmpIntent) -> dict:
    ...
    def translate(
        ...
        if payload_format == "xml":
            return self._render_and_validate_xml(data_list, "snmp.xml.j2")
        elif payload_format == "json":
            return self._render_and_validate_json(data_list, "snmp.json.j2")
        else:
